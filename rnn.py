    ...
    for sentence, labels in data:
        ...
        if (len_dif < 0):
            ...
            for i in range(0,len_dif):
                newS.append(zero_vector)
                newL.append(zero_label)
                mSeq.append(False)
        ret.append((newS,newL,mSeq))
...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        state = tf.zeros([1,self.config.hidden_size],tf.float32)
