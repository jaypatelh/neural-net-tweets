...
from sequence import TweetSequenceLookupEmbeddingConfig
...
baseline_config = TweetSequenceLookupEmbeddingConfig()
configs = [TweetSequenceLookupEmbeddingConfig() for _ in range(1)]
